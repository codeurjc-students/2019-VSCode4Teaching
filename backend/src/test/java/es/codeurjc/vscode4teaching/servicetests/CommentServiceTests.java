...
import es.codeurjc.vscode4teaching.services.CommentService;
...
public class CommentServiceTests {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CommentServiceTests.class);
    @Mock
    ...
    public void saveCommentThread() throws FileNotFoundException {
        ...
        CommentThread savedCommentThread = commentService.saveCommentThread(1L, commentThread);
    ...
    public void getCommentThreadByFile() throws FileNotFoundException {
        ...
        List<CommentThread> savedCommentThread = commentService.getCommentThreadsByFile(1L);
    ...
    public void getFilesWithCommentsByUser() throws ExerciseNotFoundException {
        ...
        List<ExerciseFile> johndoeFiles = commentService.getFilesWithCommentsByUser(1000L, "johndoe");
        List<ExerciseFile> johndoe2Files = commentService.getFilesWithCommentsByUser(1000L, "johndoe2");
    ...
    public void updateThreadLine() throws CommentNotFoundException {
        ...
        CommentThread savedCommentThread = commentService.updateCommentThreadLine(2L, 5L, "Test line 5");
