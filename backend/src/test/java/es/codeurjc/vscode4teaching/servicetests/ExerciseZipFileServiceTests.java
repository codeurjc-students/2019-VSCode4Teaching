...
public class ExerciseZipFileServiceTests {

    private static final Logger logger = LoggerFactory.getLogger(ExerciseZipFileServiceTests.class);
    @Mock
    ...
    private List<File> runSaveExerciseFiles() throws Exception {
        // Get files
        File file = Paths.get("src/test/java/es/codeurjc/vscode4teaching/files", "exs.zip").toFile();
