package es.codeurjc.vscode4teaching.controllertests;

import com.fasterxml.jackson.databind.ObjectMapper;
import es.codeurjc.vscode4teaching.controllers.dtos.JWTRequest;
import es.codeurjc.vscode4teaching.controllers.dtos.UserDTO;
import es.codeurjc.vscode4teaching.controllertests.utils.MockAuthentication;
import es.codeurjc.vscode4teaching.model.Course;
import es.codeurjc.vscode4teaching.model.Role;
import es.codeurjc.vscode4teaching.model.views.UserViews;
...
public class JWTLoginControllerTests {
    ...
    public void register() throws Exception {
        ...
        es.codeurjc.vscode4teaching.model.User expectedUser = new es.codeurjc.vscode4teaching.model.User(
        ...
        when(userService.save(any(es.codeurjc.vscode4teaching.model.User.class), eq(false)))
    ...
    public void registerTeacher() throws Exception {
        ...
        userDTO.setName("John");
        userDTO.setLastName("Doe");
        when(userService.save(any(es.codeurjc.vscode4teaching.model.User.class), eq(true)))
                .thenReturn(expectedUser);
